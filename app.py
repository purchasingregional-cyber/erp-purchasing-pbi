...
# Versi: 13.3 (ABSOLUTE FULL VERSION - ALL FEATURES RESTORED)
            ...
            if extracted_rows:
                ...
                for r in extracted_rows:
                    ...
                    if match and match[1] >= 75:
                        ...
                        # Pastikan prioritas UOM dari ekstraksi excel, jika kosong baru ambil dari master
                ...
                st.rerun()
            else: st.warning("⚠️ Data item kosong!")
...
st.markdown("---")
st.markdown(f"<p style='text-align: center; color: #94A3B8; font-size: 12px;'>ERP Purchasing System v13.3 | Proprietary of PT Panca Budi Idaman Tbk | Created with ❤️ for Raihan Subakti<br><span style='color: #10B981; font-weight: 600;'>🟢 Live Database tersinkronisasi pada: {get_sync_time()}</span></p>", unsafe_allow_html=True)