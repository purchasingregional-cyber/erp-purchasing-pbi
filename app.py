                    ...
                    if curr_po != "-":
                        ...
                        if len(val_list) >= 4:
                            ...
                            if len(numeric_finds) >= 2:
                                ...
                                if "ceper" in file_po.name.lower(): final_unit = "PBI CPR"
                                elif "pemalang" in file_po.name.lower(): final_unit = "PBI PML"
                                elif "ra " in file_po.name.lower() or "royal" in file_po.name.lower(): final_unit = "RA"
